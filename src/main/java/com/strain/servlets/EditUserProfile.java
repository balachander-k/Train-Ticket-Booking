...
//				+ "<p1 class='menu'><a href='changeuserpassword'>Change Password</a></p1>" + "</div>");
		pw.println("<div class='main' style='text-align: center;'>"
		          + "<p class='menu' style='display: inline-block; margin-right: 20px;'>"
		          + "<a href='viewuserprofile' style='text-decoration: none;'>View Profile</a></p>"
		          + "<p class='menu' style='display: inline-block; margin-right: 20px;'>"
		          + "<a href='edituserprofile' style='text-decoration: none;'>Edit Profile</a></p>"
		          + "<p class='menu' style='display: inline-block;'>"
		          + "<a href='changeuserpassword' style='text-decoration: none;'>Change Password</a></p>"
		          + "</div>");
