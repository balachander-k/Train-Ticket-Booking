...
//					+ " ! Welcome to our new NITRTC Website</p1></div>");
			pw.println("<div class='main' style='text-align: center;'>"
			          + "<p class='menu' style='font-size: 24px;'>Hello " + uName 
			          + "! Welcome to our new NITRTC Website</p>"
			          + "</div>");

			pw.println("<div class='tab'>Hello " + uName
					+ " ! Good to See You here.<br/> Here you can Check up the train "
					+ "details and train schedule,fare Enquiry and many more information.<br/>Just go to the Navigation Menu Links and "
